...
export class OrderDetailService {
    ...
    getParticipantByActivityId(id: string): Observable<GetParticipantDtoRes> {
        return this.http.get<GetParticipantDtoRes>(`http://localhost:8080/order-details/activity/${id}`)
    }
