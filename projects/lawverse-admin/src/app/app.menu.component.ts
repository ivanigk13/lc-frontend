    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                label: 'Master',
                items:[
                    { label: 'Category', icon: 'pi pi-fw pi-table', routerLink: ['/category/list'] },
                    { label: 'Industry', icon: 'pi pi-fw pi-table', routerLink: ['/industry/list'] },
                    { label: 'Position', icon: 'pi pi-fw pi-table', routerLink: ['/position/list'] },
                    { label: 'Role', icon: 'pi pi-fw pi-table', routerLink: ['/role/list'] },
                    { label: 'Transaction Status', icon: 'pi pi-fw pi-table', routerLink: ['/transaction-status/list'] },
                    { label: 'User', icon: 'pi pi-fw pi-table',routerLink: ['/user/list'] }
